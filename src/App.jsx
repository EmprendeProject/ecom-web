    ...
    <div className="landing-page">
      ...
      <main className="main-content">
        ...
        <div className="vsl-cta-wrapper" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '30px auto 0 auto', padding: '0 20px', width: '100%', maxWidth: '900px' }}>
          <a 
            href="#stands" 
            onClick={(e) => { e.preventDefault(); document.getElementById('stands').scrollIntoView({ behavior: 'smooth' }); window.fbq && window.fbq('track', 'ViewContent', { content_name: 'Stand', content_category: 'Stands' }); window.fbq && window.fbq('track', 'Lead', { content_name: 'Stand', content_category: 'Stands' }); }} 
        ...
        <section id="stands" className="nuestros-stands-section" style={{ backgroundColor: '#ffffff', padding: '80px 20px 40px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '50px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', gap: '15px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', maxWidth: '900px', gap: '15px' }}>
              <a href="https://wa.me/584226324938?text=¡Hola!%20Me%20gustaría%20información%20sobre%20los%20stands%20de%20ECOM2026" target="_blank" rel="noopener noreferrer" className="btn-vsl-cta" onClick={() => { window.fbq && window.fbq('track', 'InitiateCheckout', { content_name: 'Stand', content_category: 'Stands' }); window.fbq && window.fbq('track', 'Lead', { content_name: 'Stand', content_category: 'Stands' }); }}>
                ADQUIRIR UN STAND
              </a>
